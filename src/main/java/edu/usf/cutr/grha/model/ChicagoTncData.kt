...
(
    ...
    @Parsed var busTime1: Int? = 0,
    @Parsed var transitTime1: Int? = 0,
    @Parsed var bicycleTime1: Int? = 0,
    @Parsed var bicycleRentTime1: Int? = 0,
    @Parsed var bicycleParkTime1: Int? = 0,
    @Parsed var carTime1: Int? = 0,
    @Parsed var carParkTime1: Int? = 0,
    @Parsed var tramTime1: Int? = 0,
    @Parsed var subwayTime1: Int? = 0,
    @Parsed var railTime1: Int? = 0,
    @Parsed var cableCarTime1: Int? = 0,
    @Parsed var ferryTime1: Int? = 0,
    @Parsed var gondolaTime1: Int? = 0,
    @Parsed var funicularTime1: Int? = 0,
    @Parsed var airplaneTime1: Int? = 0,
    ...
    @Parsed var busTime2: Int? = 0,
    @Parsed var transitTime2: Int? = 0,
    @Parsed var bicycleTime2: Int? = 0,
    @Parsed var bicycleRentTime2: Int? = 0,
    @Parsed var bicycleParkTime2: Int? = 0,
    @Parsed var carTime2: Int? = 0,
    @Parsed var carParkTime2: Int? = 0,
    @Parsed var tramTime2: Int? = 0,
    @Parsed var subwayTime2: Int? = 0,
    @Parsed var railTime2: Int? = 0,
    @Parsed var cableCarTime2: Int? = 0,
    @Parsed var ferryTime2: Int? = 0,
    @Parsed var gondolaTime2: Int? = 0,
    @Parsed var funicularTime2: Int? = 0,
    @Parsed var airplaneTime2: Int? = 0,
    ...
    @Parsed var busTime3: Int? = 0,
    @Parsed var transitTime3: Int? = 0,
    @Parsed var bicycleTime3: Int? = 0,
    @Parsed var bicycleRentTime3: Int? = 0,
    @Parsed var bicycleParkTime3: Int? = 0,
    @Parsed var carTime3: Int? = 0,
    @Parsed var carParkTime3: Int? = 0,
    @Parsed var tramTime3: Int? = 0,
    @Parsed var subwayTime3: Int? = 0,
    @Parsed var railTime3: Int? = 0,
    @Parsed var cableCarTime3: Int? = 0,
    @Parsed var ferryTime3: Int? = 0,
    @Parsed var gondolaTime3: Int? = 0,
    @Parsed var funicularTime3: Int? = 0,
    @Parsed var airplaneTime3: Int? = 0,
